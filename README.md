...
public class ConstructoredClass {
	...
	public ConstructoredClass(@ParamFrom("id") int id, 
...
When an instance of the ConstructoredClass2 is read from the database, the constructor will be invoked and `a` and `id` set via the constructor, then `b` and `c` will be set by direct field access.
