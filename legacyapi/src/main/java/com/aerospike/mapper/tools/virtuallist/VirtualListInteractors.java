...
public class VirtualListInteractors {
            ...
            public Operation getOperation(OperationParameters operationParams) {
                if (listType == AerospikeEmbed.EmbedType.LIST) {
                    return ListOperation.getByValue(binName, getValue(value, false),
                            listReturnType(operationParams.getNeedsResultOfType()));
                } else {
                    return MapOperation.getByValue(binName, getValue(value, false),
                            mapReturnType(operationParams.getNeedsResultOfType()));
                }
            }
    ...
    private static int listReturnType(ReturnType returnType) {
        switch (returnType) {
            case DEFAULT:
            case ELEMENTS:
    ...
    private static int mapReturnType(ReturnType returnType) {
        switch (returnType) {
            case DEFAULT:
            case ELEMENTS:
