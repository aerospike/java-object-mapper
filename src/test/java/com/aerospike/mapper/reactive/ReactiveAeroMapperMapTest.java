...
public class ReactiveAeroMapperMapTest extends ReactiveAeroMapperBaseTest {
    ...
    public void testConvenienceMethods() {
        ...
        value.c = 3;
        value.d = 4;
        Map<String, Object> map = reactiveMapper.getMappingConverter().convertToMap(value);
        ...
        TestV1 value2 = reactiveMapper.getMappingConverter().convertToObject(TestV1.class, map);
