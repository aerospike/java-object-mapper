...
public class ReactiveSubclassMapTest extends ReactiveAeroMapperBaseTest {
    ...
    public static class Container {
        ...
        @AerospikeEmbed(type = AerospikeEmbed.EmbedType.LIST, elementType = AerospikeEmbed.EmbedType.MAP)
