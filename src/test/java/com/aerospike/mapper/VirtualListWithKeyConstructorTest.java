...
public class VirtualListWithKeyConstructorTest extends AeroMapperBaseTest {
	...
	public static class C {
		@AerospikeKey
		public int a;
		@AerospikeBin(useAccessors = true)
		public String b;
	...
	public static class B {
		...
		@Override
		public String toString() {
			return String.format("{id=%d, name=%s, date=%d, thisC=%s, listC=%s, anonC=%s}",  id, name, date, thisC, Cs, anonC);
		}
	...
	public void test() {
		...
		B b102 = new B(102, "bob", 12345, a, b, c);
