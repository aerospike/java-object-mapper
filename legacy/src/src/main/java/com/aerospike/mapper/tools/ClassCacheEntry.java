...
public class ClassCacheEntry<T> {
    ...
    ClassCacheEntry(@NotNull Class<T> clazz, IObjectMapper mapper, ClassConfig config, boolean requireRecord) {
        this.clazz = clazz;
        this.mapper = mapper;
    ...
    public void setGenerationValue(Object instance, int generation) {
        ...
        try {
            ...
            throw new AerospikeException("Failed to set generation field value", e);
        }
    }
